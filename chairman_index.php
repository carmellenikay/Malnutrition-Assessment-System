                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
					 ...
					 <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th"></i><a href="addKagawadBrgy.php">Add Kagawad Account</a></li>
                            <li><i class="menu-icon fa fa-th"></i><a href="kagawadBrgy.php">View Accounts</a></li>
                        </ul>
                    </li>
                   ...
                   <li class="menu-title">Reports</li><!-- /.menu-title -->
					<li class="menu-item-has-children dropdown">
						...
						<li><i class="menu-icon fa fa-line-chart"></i><a href="addDamageReportBrgy.php">Add Damage Report</a></li>
                            <li><i class="menu-icon fa fa-line-chart"></i><a href="damagereportinfobrgy.php">Detailed Report</a></li>
							</a></li>
                        </ul>
                    </li>
