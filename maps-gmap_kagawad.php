    ...
    <div id="right-panel" class="right-panel">
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
									...
									<li><a href="damagereportinfobrgy.php">Damage Cost Report</a></li>
        ...
        <div class="content">
            <div class="animated fadeIn">
				...
				Choose Typhoon 
						<form method="POST" action="maps-gmap_kagawad.php"> 
						<select name="tpname">
...
$string2 = "
         ...
         'color': '".$color."',
         'brgy': 'Barangay Name: ".$row['brgy'].",".$row['municipality']."<br> Damage Cost: &#8369;".number_format($legend,2)."' 
        }
    ]";
  echo $string2;
    if($rows_two == $count){
