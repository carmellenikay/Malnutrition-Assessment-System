<?php
	...
	$data = $resCon->ShowBrgyKagawad($res);	
?> 
<!doctype html>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="addResident.php">Add Resident</a></li>
                                    <li class="active">Resident Info</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Resident Information</strong>
                            </div>
                            <div class="card-body">
