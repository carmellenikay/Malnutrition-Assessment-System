<?php
	...
	$data = $bcCon->Showbarangay_chairmanAccounts();	
?> 
<!doctype html>
...
<head>
    ...
    <title>Barangay Info - Legazpi DAS</title>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Barangay Info</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Barangay Chairperson Accounts</strong>
                            </div>
                            <div class="card-body">
