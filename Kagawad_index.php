<?php
	...
	$dr -> setbrgy_id($_SESSION['brgy_id']);
	$data = $drCon->ShowDamageReportBrgy($dr);
	...
	$data4 = $resCon->ShowResidentCountBrgy($res);
    $data5 = $drCon->ShowDamageReportcountBrgy($dr);
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th"></i><a href="addResidentKagawad.php">Add Resident</a></li>
                            <li><i class="menu-icon fa fa-th"></i><a href="residentinfoKagawad.php">View Resident Info</a></li>
                        </ul>
                    </li>
                   ...
                   <li class="menu-title">Reports</li><!-- /.menu-title -->
					<li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
						<li><i class="menu-icon fa fa-line-chart"></i><a href="addDamageReportKagawad.php">Add Damage Report</a></li>
                            <li><i class="menu-icon fa fa-line-chart"></i><a href="damagereportinfoKagawad.php">Detailed Report</a></li>
					...
					<li class="menu-title">Map Locator</li><!-- /.menu-title -->
					 <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-map-o"></i><a href="maps-gmap_Kagawad.php">Assessment Map</a></li>
                        </ul>
                    </li>
                                ...
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
											...
											<?php for($ctr=0;$ctr<$data4['count'];$ctr++){
											echo $rescount=$data4['rescount'][$ctr];
											} ?>
											</span></div>
                            ...
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text"><span class="count">
											<?php for($ctr=0;$ctr<$data5['count'];$ctr++){
											echo $damagecount=$data5['damagecount'][$ctr];
											} ?>
											</span></div>
				...
				<div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Detailed Damage Report Information</strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
									...
									<?php
										for($ctr=0;$ctr<$data['count'];$ctr++)
											...
											echo "
                                        <tr>
                                            <td>&#8369; ".number_format($data['estimated_cost'][$ctr],2)."</td>
                                            <td>".$data['fullname'][$ctr]."</td>
                                            <td>".$data['brgy'][$ctr]."</td>
                                            <td>".$data['damage_type'][$ctr]."</td>
											<td>".$data['typhoon_name'][$ctr]."</td>
                                            <td>".$data['date_calamity'][$ctr]."</td>
