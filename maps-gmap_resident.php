               ...
               <ul class="nav navbar-nav">
					...
					<li class="menu-title">Map Locator</li><!-- /.menu-title -->
					 <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-map-o"></i><a href="maps-gmap_resident.php">Assessment Map</a></li>
                        </ul>
                    </li>

					<li class="menu-title">Login Account</li><!-- /.menu-title -->
					
					<li><i class="menu-icon fa ti-power-off"><a href="page-login.php"> login now!</a></i></li>
    ...
    <div id="right-panel" class="right-panel">
                    ...
                    <div class="user-area dropdown float-right">
                       <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Welcome Guest  &nbsp;
                        ...
                        <div class="user-menu dropdown-menu">
                            ...
                            <a class="nav-link" href="page-login.php"><i class="fa fa-power-off"></i>Login Account</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    <li><a href="maps-gmap_resident.php">Dashboard</a></li>
        ...
        <div class="content">
            <div class="animated fadeIn">
				...
				Choose Typhoon 
						<form method="POST" action="maps-gmap_resident.php"> 
						<select name="tpname">
