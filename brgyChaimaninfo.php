            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="AddAccount.php">Create APSEMO Account</a></li>
							<li><i class="fa fa-table"></i><a href="AddAccount.php">Create Chairman Account</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Barangay Information</strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
									...
									<?php
                                        ...
                                        <tr>
                                            ...
                                            <td>".$data['birthdate'][$ctr]."</td>
                                            <td>".$data['status'][$ctr]."</td>
                                        </tr>
										";
											}
										?>
