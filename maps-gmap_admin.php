    ...
    <div id="right-panel" class="right-panel">
            ...
            <div class="top-right">
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                       <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Welcome Admin : <?php echo $_SESSION['username'];?> &nbsp;
        ...
        <div class="content">
            <div class="animated fadeIn">
				...
				Choose Typhoon 
						<form method="POST" action="maps-gmap_admin.php"> 
						<select name="tpname">
