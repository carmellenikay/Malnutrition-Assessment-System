                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Detailed Damage Report Information per Barangay for the Year : <?php echo date('Y');?></strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
									...
									<?php
                                        ...
                                        <tr>
                                            ...
                                            <td>".$data['brgy'][$ctr]."</td>
                                            <td>".$data['caldate'][$ctr]."</td>
                                            <td>Typhoon - ".$data['typhoon_name'][$ctr]."</td>
