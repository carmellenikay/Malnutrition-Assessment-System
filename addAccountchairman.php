<?php
	...
	$bcCon = new BarangayChairmanController();
	$data = $bcCon->Showbarangay_chairman();
...
<head>
    ...
    <title>Add Apsemo Account</title>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-table"></i><a href="brgyChairmanAccount.php">View Chairperson Accounts</a></li>
                        </ul>
                    </li>
                   ...
                   <li class="menu-title">Typhoon</li><!-- /.menu-title -->
					 <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-map-o"></i><a href="addTyphoon.php">Add Typhoon info</a></li>
							 <li><i class="menu-icon fa fa-map-o"></i><a href="typhooninfo.php">View Typhoon List</a></li>
                                                    </ul>
                    </li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                Add <strong>Barangay Chairman</strong> Account
                            </div>
                            <div class="card-body card-block">
                                <form action="addAccountChairman.php" method="post" enctype="multipart/form-data" class="form-horizontal">
									...
									<div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <select name="res_id" id="res_id" class="form-control" required=required>
                                                ...
                                                <?php for($ctr=0;$ctr<$data['count'];$ctr++)
													{
														$brgyc_id = $data['brgyc_id'][$ctr];
														$brgy= $data['brgy'][$ctr];
														$res_id= $data['res_id'][$ctr];
														$fullname = $data['fullname'][$ctr];
														echo "<option value=".$res_id.">".$fullname." - Brgy. ".$brgy."</option>";
                                     ...
                                     <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="uname" name="uname" placeholder="Enter Username" class="form-control"></div>
                                    </div>
                               
								<div class="row form-group">
                                        <div class="col col-md-3"><label for="email-input" class=" form-control-label">Password</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="upass" name="upass" placeholder="Enter Password" class="form-control"></div>
                                    </div>		
