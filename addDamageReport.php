                   ...
                   <li class="menu-title">Reports</li><!-- /.menu-title -->
					<li class="menu-item-has-children dropdown">
						...
						<li><i class="menu-icon fa fa-line-chart"></i><a href="addDamageReport.php">Add Damage Report</a></li>
                            <li><i class="menu-icon fa fa-line-chart"></i><a href="damagereportinfo.php">Detailed Damage Cost</a></li>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="DamageReportinfo.php">View Damage Report</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="addDamageReport.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                   ...
                                   <div class="row form-group">
									...
									<div class="row form-group">
                                                ...
                                                <?php for($ctr=0;$ctr<$data['count'];$ctr++)
													{
														$b_id = $data['b_id'][$ctr];
														$brgy = $data['brgy'][$ctr];
														echo "<option value=".$b_id.">".$brgy."</option>";
													}
											?>
                                            </select>
                                        </div>
									 ...
									 <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                           <input type="date" id="cdate" name="cdate"required=required value="<?php echo date('Y-m-d'); ?>">
                                        </div>
                                    </div>
									 
                            <div class="card-footer">
                                <input type="submit" class="btn btn-primary btn-sm" value="add" name="add">
