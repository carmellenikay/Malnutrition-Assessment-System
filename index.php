                   ...
                   <li class="menu-title">Typhoon</li><!-- /.menu-title -->
					...
					<li class="menu-title">Map Locator</li><!-- /.menu-title -->
					 <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-map-o"></i><a href="maps-gmap_admin.php">Damage Cost Maps</a></li>
                                                    </ul>
                    </li>
    ...
    <div id="right-panel" class="right-panel">
            ...
            <div class="top-right">
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Welcome Admin <?php echo $SESSION['fullname']; ?>&nbsp;
                                ...
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text"><span class="count"><?php for($ctr=0;$ctr<$data1['count'];$ctr++){
											echo $brgycount=$data1['brgycount'][$ctr];
											} ?></span></div>
                                            <div class="stat-heading">Brgy Chairperson</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Typhoon Information</strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
									...
									<?php
                                        ...
                                        <tr>
                                            ...
                                            <td>".$data['t_year'][$ctr]."</td>
                                            <td>".$data['date_added'][$ctr]."</td>
        ...
        <footer class="site-footer">
            <div class="footer-inner bg-white">
                <div class="row">
                    <div class="col-sm-6">
                        Copyright &copy; 2018 Legazpi APSEMO
                    </div>
